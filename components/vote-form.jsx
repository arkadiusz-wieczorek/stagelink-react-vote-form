...
class VoteFrame extends React.Component {
  ...
  statusChangeCallback(response) {
    ...
    console.log('authResponse from state', this.state.authResponse)
  ...
  handleChange(param){
      ...
      //
      //   obj[param] = parseFloat(event.target.value)
      //   console.log('here')
      // }
      // else obj[param] = event.target.value
    	this.setState(obj);
		}.bind(this);
  }
      ...
      <div>
        {(this.state.voted === false)
          ...
          <div>
            ...
            <Lmap position={[this.state.lng, this.state.lat]} zoom={this.state.zoom}/>
          </div>
        }
      </div>
    )
...
ReactDOM.render(<VoteFrame />, document.querySelector('#vote-form'))
